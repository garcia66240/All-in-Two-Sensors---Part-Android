 ...
 */
public class SettingsActivity extends SettingsActivityImpl {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            String sensorID=Storage.getString(getActivity(),"SensorID","Sensor V1");
            if (sensorID.contains("V1")) {
                addPreferencesFromResource(R.xml.pref_general_temp);
                bindPreferenceSummaryToValue(findPreference("Name"));
                bindPreferenceSummaryToValue(findPreference("prop_units"));
            }
            if (sensorID.contains("V2")) {
                addPreferencesFromResource(R.xml.pref_general_temp_hum);
                bindPreferenceSummaryToValue(findPreference("Name"));
                bindPreferenceSummaryToValue(findPreference("prop_units"));
            }
            if (sensorID.contains("V3")) {
                addPreferencesFromResource(R.xml.pref_general_temp_hum_bar);
                bindPreferenceSummaryToValue(findPreference("Name"));
                bindPreferenceSummaryToValue(findPreference("prop_units"));
            }
            if (sensorID.contains("V4")) {
                addPreferencesFromResource(R.xml.pref_general_lux);
                bindPreferenceSummaryToValue(findPreference("Name"));
                bindPreferenceSummaryToValue(findPreference("Prop_domaine"));
            }
    ...
    public static class InfosPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("SensorID"));
    ...
    public static class IntervalPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(true);
            bindPreferenceSummaryToValue(findPreference("prop_units"));
            bindPreferenceSummaryToValue(findPreference("prop_frequency"));
        }
    ...
    public static class ExitPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            intent=WifiUtil.dispatchActivity(getActivity());
